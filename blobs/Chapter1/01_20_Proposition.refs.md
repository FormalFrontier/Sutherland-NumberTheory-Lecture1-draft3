# References for Chapter1/01_20_Proposition

## Mathlib
- Coverage: `exact`
- Declarations: `isIntegral_trans`
- Notes: Mathlib already has the transitivity theorem for integrality in towers, matching the proposition directly once the scalar-tower hypotheses are in place.
...
- Stage 3 should use `isIntegral_trans` directly unless it specifically needs the cited textbook proof pattern for an intermediate lemma.
